...
int main() {
  ...
  std::cout << "\n---- Displaying the first 20 books after sorting ----"
            << std::endl;
  display_books(books, 20);
  // Work with a subset of data for Merge Sort to demonstrate recursion
  std::vector<Book> top_books(books.begin(),
                              books.begin() + 100); // Use the top 100 books
  // Display first 20 books before merge sort by rating
  std::cout << "\n---- Displaying the first 20 books before merge sort ----"
            << std::endl;
  display_books(top_books, 20);
  std::cout << "\n---- Chapter 3: Merge Sort by Rating ----" << std::endl;
  ...
  std::cout << "Books sorted by rating using merge sort." << std::endl;
  std::cout << "Sorting took " << sort_time_taken.count() << " seconds."
            << std::endl;
  // Display first 20 books after merge sort by rating
  std::cout << "\n---- Displaying the first 20 books after merge sort ----"
            << std::endl;
  display_books(top_books, 20);
  return 0;
}